...
app.post('/photographer/signups', async (req, res) => { 
  const { registerID, fname, lname,linkTo phoneNO, email, password, location } = req.body;

  // Validate input data
  if (!lname || !fname || !registerID || !phoneNO || !email || !password || !location) {
...
app.post('/createprofile', async (req, res) => {
  console.log('********* Request body:', req.body);
  const { registerID, fname, lname, phoneNO, email, password, location } = req.body;
  ...
  try {
    ...
    const newProfile = new Photographer({ registerID, fname, lname, phoneNO, email, password, location });
