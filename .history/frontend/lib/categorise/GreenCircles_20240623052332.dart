              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildDetailItem(context, themeProvider, Icons.person_sharp,"Photographer"+" "+ S.of(context).Name, "Safaa" + " " + "Billal"),
                      _buildDetailItem(context, themeProvider, Icons.table_chart, S.of(context).Events, "Wedding"),
                      _buildDetailItem(context, themeProvider, Icons.date_range_rounded, S.of(context).Date, "2022-06-01"),
                      _buildDetailItem(context, themeProvider, Icons.phone, S.of(context).Phone, "0599999999"),
                      _buildDetailItem(context, themeProvider, Icons.place, S.of(context).Places, "Saraya Shireen", onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LocationDetailPage(
                              locationName: "Saraya Shireen", // Replace with actual location name
                              image: "assets/web/saraya.jpg", // Replace with actual image path
                              stars: 5, // Replace with actual star rating
                              price: 600, // Replace with actual price
                              owner: "Sameh Darwazeh", // Replace with actual owner name
                              phone: 50000000000, // Replace with actual phone number
                              address: "Nablus-old university street", // Replace with actual address
                            ),
                          ),
                        );
                      }),
