              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildDetailItem(context, themeProvider, Icons.person_sharp,"Photographer"+" "+ S.of(context).Name, "Safaa" + " " + "Darwazeh"),
                      _buildDetailItem(context, themeProvider, Icons.table_chart, S.of(context).Events, "Graduation"),
                      _buildDetailItem(context, themeProvider, Icons.date_range_rounded, S.of(context).Date, "2024-06-01"),
                      _buildDetailItem(context, themeProvider, Icons.phone, S.of(context).Phone, "0599999999"),
                      _buildDetailItem(context, themeProvider, Icons.place, S.of(context).Places, "Darwazeh studio", onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LocationDetailPage(
                              locationName: "Darwazeh studio", // Replace with actual location name
                              image: "assets/web/darwazeh.jpg", // Replace with actual image path
