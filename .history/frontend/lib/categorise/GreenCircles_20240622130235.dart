              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _buildDetailItem(context, themeProvider, Icons.person_sharp, S.of(context).Name, "description" + " " + item["description"]),
                      _buildDetailItem(context, themeProvider, Icons.book, S.of(context).Events, item["description"]),
