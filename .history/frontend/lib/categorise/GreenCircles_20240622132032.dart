                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      _buildDetailItem(context, themeProvider, Icons.place, S.of(context).Places, "Pardo Coffe", 
                      onTap: () {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => LocationDetailPage(
        ...
        image: "assets/images/pardo_coffe.jpg", // Replace with actual image path
        ...
        address: "123 Main St, City", // Replace with actual address
      ),
    ),
  );
}),
