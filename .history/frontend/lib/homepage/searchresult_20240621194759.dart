...
void _navigateToLocationDetail(String location) {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => LocationDetailPage(
          ...
          image: 'assets/web/amanda_house.jpg',
          stars: 3,
          price: 8,
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => LocationDetailPage(
          ...
          image: 'assets/web/balaa_villa.jpg',
          stars: 5,
          price: 100,
  ...
  } else if (location == 'Darwazeh stdio') {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LocationDetailPage(
          locationName: 'Darwazeh stdio',
          image: 'assets/web/darwazeh_stdio.jpg',
          stars: 4,
          price: 50,
          address: 'Nablus - Darwazeh',
        ),
      ),
    );
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => LocationDetailPage(
          ...
          image: 'assets/web/golden_house.jpg',
          stars: 4,
          price: 80,
          address: 'Nablus - Golden Street',
        ),
      ),
    );
  }
