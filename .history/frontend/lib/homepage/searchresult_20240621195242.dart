...
class _SearchResultState extends State<SearchResult> {
  ...
  void _navigateToLocationDetail(String location) {
    if (location == 'Amanda House') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LocationDetailPage(
            locationName: 'Amanda House',
            image: 'assets/web/amanda_house.jpg', // replace with your image path
            stars: 3,
            price: 8,
            owner: 'Saad Saad',
            phone: 0599999999,
            address: 'Nablus - Tell Huwwara City',
          ),
        ),
      );
    } else if (location == 'Balaa Villa') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LocationDetailPage(
            locationName: 'Balaa Villa',
            image: 'assets/web/balaa_villa.jpg', // replace with your image path
            stars: 5,
            price: 100,
            owner: 'Mahmoud Tuhul',
            phone: 0599382671,
            address: 'Tulkarm - Bala\'a Village',
          ),
        ),
      );
    }else if (location == 'Darwazeh studio') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LocationDetailPage(
            locationName: 'Darwazeh studio',
            image: 'assets/web/darwazeh.jpg', // replace with your image path
            stars: 5,
            price: 150,
            owner: 'Sameh Darwazeh',
            phone: 0500000000,
            address: 'Nablus- Old university street',
          ),
        ),
      );
    }

    else if (location == 'Golden house') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => LocationDetailPage(
            locationName: 'Golden house ',
            image: 'assets/web/balaa_villa.jpg', // replace with your image path
            stars: 5,
            price: 100,
            owner: 'Mahmoud Tuhul',
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    // Handle location tap
                                  _navigateToLocationDetail(_founditems[index]["location"]);
