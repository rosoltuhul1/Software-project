          ...
          children: [
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: 'Search', // Replace with S.of(context).Search if localization is set up
                ...
                isTextFieldFocused
                    ? TextButton(
                        ...
                        child: Text(
                          'Cancel', // Replace with S.of(context).Cancel if localization is set up
                          style: TextStyle(
                            fontSize: 18.0,
            ...
            if (!isTextFieldFocused || showImages)
              ...
              Expanded(
                child: Center(
                  child: Text(
                    'No results found', // Replace with S.of(context).Noresultsfound if localization is set up
                    style: TextStyle(
                      fontSize: 18,
                      color: themeProvider.isDarkMode
                          ? const Color(0xFFffffff)
