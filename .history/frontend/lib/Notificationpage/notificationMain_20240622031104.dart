...
class _NotificationMainState extends State<NotificationMain> {
  ...
  void initState() {
    super.initState();
    isClicked = List.filled(widget.reservedArray.length + widget.resultReservedArray.length, false);
  }
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              buildNotification("User is checking for an appointment", Icons.chat_bubble, 0),
              // Second Notification: Likes on picture
              buildNotification("4 likes on your picture other1.jpg", Icons.favorite, 1),
              // Third Notification: Weather forecast
              buildNotification("Fantastic weather tomorrow in Nablus at 3:00 PM", Icons.cloud, 2),
              Expanded(
  ...
  Widget buildNotification(String text, IconData icon, int index) {
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: isClicked[index] ? Colors.blue : Colors.grey.shade300,
        ...
        child: Row(
          children: [
            ...
            Text(text),
            const Spacer(),
            Icon(Icons.check, color: isClicked[index] ? Colors.blue : Colors.transparent),
          ],
        ),
      ),
    );
