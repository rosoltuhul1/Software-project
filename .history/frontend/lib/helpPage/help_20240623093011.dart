...
class _helpPageState extends State<helpPage> {
  ...
  Future<void> sendMessage(String message) async {
    ...
    if (message.toLowerCase().contains("hello") || message.contains("مرحبا")) {
      ...
      response = Intl.getCurrentLocale() == 'ar'
          ? "اهو تطبيق جوال مبتكر مصمم للمصورين من جميع المستويات، من المبتدئين إلى المحترفين. سواء كنت تلتقط صوراً لحفلات الزفاف أو الولادات أو التخرج أو اللحظات الخاصة الأخرى LensScout الأدوات والميزات التي تحتاجها لتحسين تجربتك في التصوير الفوتوغرافي.ي"
