  ...
  if (response.statusCode == 200) {
    ...
    setState(() {
      items = data.map((post) {
        return {
           "id": post["_id"],
          // "image": 'http://$ipAddress:3000${post["image"]}', // Use the full URL for the image
          // "image" = 'http://10.0.2.2:3000/' + post['image'],
          "description": post["description"],
        };
      }Profileimage = 'http://10.0.2.2:3000/' + post['profilePicture'];).toList();
    });
    print("dfff");
    print(items);
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    backgroundColor: themeProvider.isDarkMode ? Colors.black54 : const Color(0xFFffffff),
    body: ListView(
      ...
      child: Column(
        ...
        children: [
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: themeProvider.isDarkMode ? const Color(0xFFffffff) : const Color(0xFF000000),
                    ),
                  ),
                  Text(
                    Level,
          ...
          SizedBox(
            ...
            child: Divider(
              thickness: 2,
              color: themeProvider.isDarkMode ? const Color(0xFFffffff) : Colors.black45,
            ),
          ),
        ],
      ),
