...
class _AccountScreenState extends State<editAccount> {
  ...
  void _navigateToCourse() {
    ...
    if (selectedLevel == 'beginner') {
      url = 'https://www.youtube.com/watch?v=dwrGAoZIrOw&list=PL7W5udALs-AlIByQQ8KnleHQdKq_9m0vD';
    } else if (selectedLevel == 'intermediate') {
      url = 'https://www.youtube.com/watch?v=ujaCbzLwuB8&list=PLG3eOzJfQr2e2OD4W0GmcSpO5oZ-c5FIu';
    } else {
      return; // No URL for 'professional'
    }
    _launchURL(url);
  }
              ...
              if (selectedLevel == 'beginner' || selectedLevel == 'intermediate')
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      selectedLevel == 'beginner' ? 'Courses for Beginner' : 'Courses for Intermediate',
                      style: TextStyle(fontSize: 20, letterSpacing: 2, color: Colors.white),
                    ),
