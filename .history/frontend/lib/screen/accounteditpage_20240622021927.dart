...
class _AccountScreenState extends State<editAccount> {
    ...
    try {
      final response = await http.post(
        ...
        body: {
          ...
          'proficiencyLevel': proficiencyLevel.isNotEmpty ? proficiencyLevel : widget.proficiencyLevel,
        },
      );
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          widget.proficiencyLevel = proficiencyLevel.isNotEmpty ? proficiencyLevel : widget.proficiencyLevel;
        });
      } else {
  ...
  Widget buildCoursesButton(String level) {
    return ElevatedButton(
      onPressed: () {
        // Navigate to the courses page for the selected level
      },
      child: Text('Courses for $level'),
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              buildCoursesButton(selectedLevel),  // Add the courses button here
              SizedBox(
                height: 30,
              ),
              Row(
